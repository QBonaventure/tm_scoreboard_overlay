...
config :tm_scoreboard_overlay, TMSO.ExternalService.Maniaplanet,
  redirect_uri: "http://192.168.1.90:4000/auth/maniaplanet/callback",
...
config :tm_scoreboard_overlay, TMSOWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tm_scoreboard_overlay_web/{live,views}/.*(ex)$",
      ~r"lib/tm_scoreboard_overlay_web/templates/.*(eex)$",
